...
const MeatDetailModal = ({ meat, onClose }: { meat: MeatNutrient, onClose: () => void }) => {
  const details = [
    ...
    { label: '水份', value: `${meat.moisture || 0} g` },
    { label: '蛋白质', value: `${meat.protein} g` },
    { label: '胆碱', value: `${meat.choline || 0} mg` },
    ...
    { label: '铜', value: `${meat.copper || 0} mg` },
    { label: '锰', value: `${meat.manganese || 0} mg` },
    { label: '碘', value: `${meat.iodine || 0} mg` },
    { label: '镁', value: `${meat.magnesium || 0} mg` },
    { label: '钠', value: `${meat.sodium || 0} mg` },
    { label: 'VA', value: `${meat.va || 0} IU` },
    { label: 'VB1', value: `${meat.vb1 || 0} mg` },
    { label: 'VB2', value: `${meat.vb2 || 0} mg` },
    { label: 'VB3', value: `${meat.vb3 || 0} mg` },
    { label: 'VB5', value: `${meat.vb5 || 0} mg` },
    { label: 'VB6', value: `${meat.vb6 || 0} mg` },
    { label: 'VB7', value: `${meat.vb7 || 0} μg` },
    { label: 'VB9', value: `${meat.vb9 || 0} μg` },
    { label: 'VB12', value: `${meat.vb12 || 0} μg` },
    { label: 'VD', value: `${meat.vd || 0} IU` },
    { label: 'VE', value: `${meat.ve || 0} mg` },
    { label: '钾', value: `${meat.potassium || 0} mg` },
    { label: '牛磺酸', value: `${meat.taurine} mg` },
    { label: 'EPA', value: `${meat.epa || 0} mg` },
    { label: 'DHA', value: `${meat.dha || 0} mg` },
    { label: 'EPA&DHA', value: `${meat.epa_dha || 0} mg` },
  ];
